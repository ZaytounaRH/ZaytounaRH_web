...
final class BudgetBackController extends AbstractController
{
    ...
    {
        return $this->render('backend/budget/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backend/budget/new.html.twig', [
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('backend/budget/show.html.twig', [
            'budget' => $budget,
        ]);
    }
    ...
    public function edit(Request $request, Budget $budget, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backend/budget/edit.html.twig', [
            'form' => $form,
        ]);
    }
